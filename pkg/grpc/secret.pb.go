...
// 	protoc        v4.25.1
// source: api/protos/secret.proto
...
func (x *LoginPassword) Reset() {
	*x = LoginPassword{}
	mi := &file_api_protos_secret_proto_msgTypes[0]
...
func (*LoginPassword) Descriptor() ([]byte, []int) {
	return file_api_protos_secret_proto_rawDescGZIP(), []int{0}
}
...
func (x *Text) Reset() {
	*x = Text{}
	mi := &file_api_protos_secret_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Text) Descriptor() ([]byte, []int) {
	return file_api_protos_secret_proto_rawDescGZIP(), []int{1}
}
...
func (x *Binary) Reset() {
	*x = Binary{}
	mi := &file_api_protos_secret_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Binary) Descriptor() ([]byte, []int) {
	return file_api_protos_secret_proto_rawDescGZIP(), []int{2}
}
...
func (x *Card) Reset() {
	*x = Card{}
	mi := &file_api_protos_secret_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Card) Descriptor() ([]byte, []int) {
	return file_api_protos_secret_proto_rawDescGZIP(), []int{3}
}
...
var File_api_protos_secret_proto protoreflect.FileDescriptor

const file_api_protos_secret_proto_rawDesc = "" +
	"\n" +
	"\x17api/protos/secret.proto\x12\x0fgophkeeper.grpc\"\xf4\x01\n" +
	...
	"\tMetaEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B-Z+github.com/sbilibin2017/gophkeeper/pkg/grpcb\x06proto3"

var (
	file_api_protos_secret_proto_rawDescOnce sync.Once
	file_api_protos_secret_proto_rawDescData []byte
)

func file_api_protos_secret_proto_rawDescGZIP() []byte {
	file_api_protos_secret_proto_rawDescOnce.Do(func() {
		file_api_protos_secret_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_protos_secret_proto_rawDesc), len(file_api_protos_secret_proto_rawDesc)))
	})
	return file_api_protos_secret_proto_rawDescData
}

var file_api_protos_secret_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_api_protos_secret_proto_goTypes = []any{
	...
	nil,                   // 4: gophkeeper.grpc.LoginPassword.MetaEntry
	nil,                   // 5: gophkeeper.grpc.Text.MetaEntry
	nil,                   // 6: gophkeeper.grpc.Binary.MetaEntry
	nil,                   // 7: gophkeeper.grpc.Card.MetaEntry
}
var file_api_protos_secret_proto_depIdxs = []int32{
	4, // 0: gophkeeper.grpc.LoginPassword.meta:type_name -> gophkeeper.grpc.LoginPassword.MetaEntry
	5, // 1: gophkeeper.grpc.Text.meta:type_name -> gophkeeper.grpc.Text.MetaEntry
	6, // 2: gophkeeper.grpc.Binary.meta:type_name -> gophkeeper.grpc.Binary.MetaEntry
	7, // 3: gophkeeper.grpc.Card.meta:type_name -> gophkeeper.grpc.Card.MetaEntry
...
func init() { file_api_protos_secret_proto_init() }
func file_api_protos_secret_proto_init() {
	if File_api_protos_secret_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_protos_secret_proto_rawDesc), len(file_api_protos_secret_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_protos_secret_proto_goTypes,
		DependencyIndexes: file_api_protos_secret_proto_depIdxs,
		MessageInfos:      file_api_protos_secret_proto_msgTypes,
	}.Build()
	File_api_protos_secret_proto = out.File
	file_api_protos_secret_proto_goTypes = nil
	file_api_protos_secret_proto_depIdxs = nil
}
