...
const file_secret_proto_rawDesc = "" +
	...
	"\vsecret_name\x18\x01 \x01(\tR\n" +
	"secretName2N\n" +
	"\x12SecretWriteService\x128\n" +
	"\x03Add\x12\x19.bankcard.EncryptedSecret\x1a\x16.google.protobuf.Empty2\x8e\x01\n" +
...
var file_secret_proto_depIdxs = []int32{
	0, // 0: bankcard.SecretWriteService.Add:input_type -> bankcard.EncryptedSecret
	...
	2, // 3: bankcard.SecretWriteService.Add:output_type -> google.protobuf.Empty
