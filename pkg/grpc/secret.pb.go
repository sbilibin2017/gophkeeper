...
const file_secret_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2D\n" +
	"\x12SecretWriteService\x12.\n" +
	"\x04Save\x12\x0e.secret.Secret\x1a\x16.google.protobuf.Empty2v\n" +
...
var file_secret_proto_goTypes = []any{
	...
	(*Secret)(nil),                // 1: secret.Secret
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 3: google.protobuf.Empty
}
var file_secret_proto_depIdxs = []int32{
	2, // 0: secret.Secret.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: secret.Secret.updated_at:type_name -> google.protobuf.Timestamp
	1, // 2: secret.SecretWriteService.Save:input_type -> secret.Secret
	0, // 3: secret.SecretReadService.Get:input_type -> secret.SecretGetRequest
	3, // 4: secret.SecretReadService.List:input_type -> google.protobuf.Empty
	3, // 5: secret.SecretWriteService.Save:output_type -> google.protobuf.Empty
	1, // 6: secret.SecretReadService.Get:output_type -> secret.Secret
	1, // 7: secret.SecretReadService.List:output_type -> secret.Secret
