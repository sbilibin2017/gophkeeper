...
const (
	...
	AuthService_GetUsername_FullMethodName = "/auth.AuthService/GetUsername"
)
...
type AuthServiceClient interface {
	...
	GetUsername(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetUsernameResponse, error)
}
...
func (c *authServiceClient) GetUsername(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetUsernameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	GetUsername(context.Context, *emptypb.Empty) (*GetUsernameResponse, error)
...
func (UnimplementedAuthServiceServer) GetUsername(context.Context, *emptypb.Empty) (*GetUsernameResponse, error) {
...
func _AuthService_GetUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUsername(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
