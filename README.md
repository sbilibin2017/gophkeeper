...
Это проект клиент-серверной системы для безопасного хранения логинов, паролей, бинарных данных и прочей приватной информации.  
Проект реализует регистрацию, аутентификацию, авторизацию пользователей, синхронизацию данных между клиентами, а также управление секретами.
