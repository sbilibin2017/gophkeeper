...
func NewSecretWriteServer(writer SecretWriter, jwtParser JWTParser) *SecretWriteServer {
...
func NewSecretReadServer(reader SecretReader, jwtParser JWTParser) *SecretReadServer {
